...
public class Matrix {
		...
		public Matrix(Matrix source, int width0, int widthN, int height0, int heightN) {
		 ...
		 */
		public Matrix(int width, int height, BiFunction<Integer, Integer, Integer> countFunction, BiFunction<Integer, Integer, Long> bitsFunction) {
